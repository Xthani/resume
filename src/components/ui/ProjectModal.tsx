    ...
    <>
      <Modal isOpen={isOpen} onClose={handleProjectModalClose} className="p-6 md:p-8 overflow-y-auto">
        <div className="space-y-6">
          ...
          {/* Изображение проекта */}
          <div 
            className="relative w-full h-48 md:h-64 rounded-lg overflow-hidden bg-gradient-to-br from-accent/5 to-accent/10 border border-accent/20 cursor-pointer group"
