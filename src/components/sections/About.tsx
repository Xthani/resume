                    ...
                    >
                        ...
                        <div className="space-y-4 text-lg text-foreground/80">
                            <p className="text-lg text-foreground/70 max-w-md text-balance text-wrap">
                                Меня зовут Станислав. Я фронтенд-разработчик с опытом создания интерфейсов на React,
                                TypeScript и Redux, а также с использованием других современных инструментов и
                                библиотек.
                            </p>
                            <p className="text-lg text-foreground/70 max-w-md text-balance text-wrap">
